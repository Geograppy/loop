...
from .strategy import CloseLoopStrategy, NoopStrategy
...
class TestNoopStrategy(unittest.TestCase):
    ...
    def test_noop_returns_same_location(self):
        ...
        result = strategy.next_move(loc, field, max_moving_speed=1.4, player_id="p1", visited_nodes=set())
    ...
    def test_noop_ignores_speed_and_time(self):
        ...
        result = strategy.next_move(loc, field, max_moving_speed=10.0, player_id="p1", visited_nodes=set(), current_time=current_time)
        self.assertEqual(result, loc)
...
class TestCloseLoopStrategy(unittest.TestCase):
    ...
    def test_first_move_on_close_loop_strategy_with_no_trajectory(self):
        ...
        loc: Location = Location.from_address("Jeugdsquare 5, 3210 Linden")
        ...
        result = strategy.next_move(loc, field, max_moving_speed=4, player_id="p1", visited_nodes=set(), current_time=timestamp2)
    ...
    def test_2_moves_within_1_edge_on_close_loop_strategy(self):
        ...
        result1 = strategy.next_move(loc, field, max_moving_speed=4, player_id="p1", visited_nodes=set(), current_time=timestamp2)
        self.assertIsNotNone(result1)

        result2 = strategy.next_move(result1, field, max_moving_speed=4, player_id="p1", visited_nodes=set(), current_time=timestamp3)
    ...
    def test_2_moves_across_multiple_edges_on_close_loop_strategy(self):
        ...
        result1 = strategy.next_move(loc, field, max_moving_speed=40, player_id="p1", visited_nodes=set(), current_time=timestamp2)
        self.assertIsNotNone(result1)

        result2 = strategy.next_move(result1, field, max_moving_speed=40, player_id="p1", visited_nodes=set(), current_time=timestamp3)
